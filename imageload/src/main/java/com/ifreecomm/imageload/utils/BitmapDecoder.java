...
public abstract class BitmapDecoder {
     ...
     * @return
     */
    public final Bitmap decodeBitmap(int width, int height, Bitmap.Config inPreferredConfig) {
        // 如果请求原图,则直接加载原图
        if (width <= 0 || height <= 0) {
        ...
        configBitmapOptions(options, width, height, inPreferredConfig);
     ...
     * @param height
     */
    protected void configBitmapOptions(Options options, int width, int height, Bitmap.Config inPreferredConfig) {
        // 设置缩放比例
